...
def massConverter():
    m1, m2, redM, totM = sympy.symbols('m1 m2 mu M', positive=True)
    expr1 = totM-m1-m2
    expr2 = redM-(m1*m2)/(m1+m2)
    sympy.pprint(sympy.solve((expr1, expr2), (totM, redM)))
    sympy.pprint(sympy.solve((expr1, expr2), (m1, m2)))
    return
massConverter()
